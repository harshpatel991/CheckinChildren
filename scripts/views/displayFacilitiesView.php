...
?>
    ...
    <p>
        ...
        <a href="displayFacilityChildren.php?facility_id=<?=$facility->facility_id;?>" class="btn btn-success"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> View all Children</a>
