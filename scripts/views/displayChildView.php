...
if(isset($_GET['child_id'])) {
    ...
    <a class="btn btn-success" href="editChild.php?child_id=<?php echo $_GET['child_id']; ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit This Child</a>
    <hr>
