<?php
/**
 * Creates a template to load in the page for the create child page viewed by managers and employees
 */
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <?php require_once(dirname(__FILE__).'/../scripts/views/createChildView.php');?>
                </div>
            </div>
        </div>
