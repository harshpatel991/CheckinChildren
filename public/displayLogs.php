<?php
/**
 * Creates a template to load in the page for the viewing of logs as seen by managers an companies
 */
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <?php require_once(dirname(__FILE__).'/../scripts/views/displayLogsView.php'); ?>
                </div>
            </div>
        </div>
