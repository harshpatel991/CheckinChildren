<?php
/**
 * Creates a template to load in the page for the editing of facilities viewed by companies
 */
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php require_once(dirname(__FILE__).'/../scripts/views/editFacilityView.php'); ?>
        </div>
    </div>
</div>
