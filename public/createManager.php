<?php
/**
 * Creates a template to load in the page for the create manager page viewed by companies
 */
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <?php require_once(dirname(__FILE__).'/../scripts/views/createManagerView.php'); ?>
                </div>
            </div>
        </div>
