<?php
/**
 * Creates a template to load in the page for the displaying of a parents info as viewed by parents
 */
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <?php require_once(dirname(__FILE__).'/../scripts/views/displayParentInfoView.php'); ?>
                </div>
            </div>
        </div>
